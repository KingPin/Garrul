...
posting, voting, reacting or paging through replies each cost their own
request. Those scale with engagement rather than traffic, which is why
they're not usually where a free-tier install runs out.
